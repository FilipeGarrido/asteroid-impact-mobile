...
public class ExplosionPowerUpScript : MonoBehaviour
{
    ...
    public static System.Action ExplosionPowerUpEvent = null;
    ...
    void OnTriggerEnter2D(Collider2D other)
    {
        if(other.gameObject.tag == "Player"){
            if(ExplosionPowerUpEvent != null){
                ExplosionPowerUpEvent();
            }
